...
public:
	...
	virtual bool SerializeEvent( IGameEvent *event, class bf_write *buf ) = 0;
	virtual IGameEvent *UnserializeEvent( class bf_read *buf ) = 0; // create new KeyValues, must be deleted
};
